...
### Pre-calculated  `r cancer_n`.`r beverage_n`.`r cancer` `r beverage` 
...
```{r}
tmp <- data.frame(name=paste0(cancer, "_", beverage) , cancer=cancer, beverage=beverage, RR=meta:::backtransf(meta$TE.random, sm = meta$sm),lower=meta:::backtransf(meta$lower.random, sm = meta$sm),higher=meta:::backtransf(meta$upper.random, sm = meta$sm),I2=meta$I2,I2_lower=meta$lower.I2,I2_upper=meta$upper.I2)
...
if(length(fo$out.study.random)!= 0){
  ...
  tmp <- data.frame(name = paste0(cancer, "_", beverage,"_outliers"),cancer=cancer, beverage = paste0(beverage), RR=meta:::backtransf(meta$TE.random, sm = meta$sm), lower=meta:::backtransf(meta$lower.random, sm = meta$sm), higher=meta:::backtransf(meta$upper.random, sm = meta$sm),I2=meta$I2,I2_lower=meta$lower.I2,I2_upper=meta$upper.I2)
...
### Event rate `r cancer_n`.`r beverage_n`.`r cancer` `r beverage` 
...
```{r}
tmp <- data.frame(name=paste0(cancer, "_", beverage,"_calc") , cancer=cancer, beverage=beverage, RR=meta:::backtransf(meta$TE.random, sm = meta$sm),lower=meta:::backtransf(meta$lower.random, sm = meta$sm),higher=meta:::backtransf(meta$upper.random, sm = meta$sm),I2=meta$I2,I2_lower=meta$lower.I2,I2_upper=meta$upper.I2)
